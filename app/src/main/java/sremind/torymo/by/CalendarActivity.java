...
/**
 * Created by torymo on 09.02.2016.
 */
public class CalendarActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CalendarActivity.onlySeen = pref.getBoolean(PREF_SEEN, false);
    ...
    private void changeSeenTitle(MenuItem miOnlySeen){
        ...
        if(CalendarActivity.onlySeen) seenTitle = R.string.action_all;
        ...
        switch(item.getItemId()){
            case R.id.action_update_episodes:
                ...
                for(int i = 0; i<cnt; i++){
                    ...
                    WatchlistActivity.addEpisodes(getBaseContext(), database, tmp.ImdbId());
                }
                Toast.makeText(getBaseContext(), R.string.slist_updated, Toast.LENGTH_SHORT).show();
                return true;
            case R.id.action_only_seen:
                CalendarActivity.onlySeen = !CalendarActivity.onlySeen;
                SharedPreferences pref = getPreferences(MODE_PRIVATE);
                SharedPreferences.Editor editor = pref.edit();
                editor.putBoolean(PREF_SEEN, CalendarActivity.onlySeen);
                editor.commit();
                refreshCalendar();
    ...
    protected void onPrepareDialog(int id, Dialog dialog) {
        if(id == SHOW_EPISODES){
            ...
            episodesList = database.getEpisodesForDate(selectedDate, CalendarActivity.onlySeen);
